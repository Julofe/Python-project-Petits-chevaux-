...
rect3a6=can.create_rectangle(215,350,246,371,fill="green")
rect3a1=can.create_rectangle(215,527,246,506,fill="green")
rect3a2=can.create_rectangle(215,496,246,475,fill="green")
rect3a3=can.create_rectangle(215,465,246,444,fill="green")
rect3a4=can.create_rectangle(215,434,246,413,fill="green")
rect3a5=can.create_rectangle(215,402,246,382,fill="green")
